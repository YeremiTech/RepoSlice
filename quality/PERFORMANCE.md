...
The scheduled quality workflow uploads the JSON performance summaries and real-corpus validation report as GitHub Actions artifacts for comparison between runs.
